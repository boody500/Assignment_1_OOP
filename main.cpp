...
//     adding two obj a+b
    ...
    if(num1 < num2)
    {
        cout << "Yup,The first number is less than the second number. \n";
    }
    else
    {
        cout << "Nope ,The first number is more than the second number. \n";
    }
...
// return size and sign
    cout << "the size = " << num1.size() << endl;
    cout << "the sign = " << num1.Sign() << endl;
